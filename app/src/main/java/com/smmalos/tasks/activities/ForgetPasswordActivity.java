...
public class ForgetPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailOrPhoneEditText = findViewById(R.id.activity_forget_password_email_address_field);
        mLoginButton = findViewById(R.id.activity_forget_password_login_button);
        mResetButton = findViewById(R.id.activity_forget_password_reset_button);
