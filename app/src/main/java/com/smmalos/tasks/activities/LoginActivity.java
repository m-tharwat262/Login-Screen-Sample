...
import com.smmalos.tasks.models.UserObject;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void checkUserAlreadyLoggedIn() {
        ...
        if(firebaseUser != null) {
            ...
            if (phoneNumber.isEmpty() || committee.isEmpty() || age == -1) {

                Intent intent = new Intent(LoginActivity.this, AddMoreInfoActivity.class);
                        ...
                        mDatabaseReference.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot snapshot) {
                                ...
                                if (userObject != null) {
                                    ...
                                    String committee = userObject.getCommittee();
                                    ...
                                    editor.putInt(getString(R.string.user_age), age);
                                    editor.putString(getString(R.string.user_phone_number), phoneNumber);
                                    editor.putString(getString(R.string.user_committee), committee);
